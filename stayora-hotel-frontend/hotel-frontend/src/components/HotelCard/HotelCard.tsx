...
export function HotelCard({
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-card bg-white shadow-[0_8px_24px_rgba(16,24,40,0.08)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_48px_rgba(16,24,40,0.16)]">
      <Link
        to={`/hotels/${hotel.id}`}
      ...
      <div className="flex flex-1 flex-col gap-2.5 p-6">
        ...
        <div className="mt-auto flex items-end justify-between pt-2">
          ...
          <span className="relative z-10 rounded-pill bg-teal/10 px-3.5 py-2 text-xs font-semibold text-teal transition-colors group-hover:bg-teal group-hover:text-white">
            View details
          </span>
        </div>
      </div>
...
export function HotelCardSkeleton() {
  return (
    <div className="flex flex-col overflow-hidden rounded-card bg-white shadow-[0_8px_24px_rgba(16,24,40,0.08)]">
      <div className="h-52 w-full animate-pulse bg-line" />
      <div className="flex flex-col gap-3 p-6">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <div className="h-8 w-24 animate-pulse rounded-pill bg-line" />
        </div>
      </div>
    </div>
  );
